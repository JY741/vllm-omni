...
"""Distributed communication primitives for context parallelism.

Ported from MGM-Video-Ascend mimogpt/models/dit/communications.py.
Implements Ulysses-style sequence parallelism: split sequence across
ranks before attention, gather after attention.
"""
